...
mv -f /tmp/resources/conf/carbon.xml /wso2/wso2am-2.1.0/repository/conf/carbon.xml
mv -f /tmp/resources/conf/api-manager.xml /wso2/wso2am-2.1.0/repository/conf/api-manager.xml
mv -f /tmp/resources/conf/tomcat/catalina-server.xml /wso2/wso2am-2.1.0/repository/conf/tomcat/catalina-server.xml
